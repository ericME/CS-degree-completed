...
int main() {
  ...
  zzzadventurercardplay(drawnTreasure, thisPlayer, cardDrawn, hand, 0, store_game);
  // ----------- TEST 1: No need to shuffle deck cards --------------
  printf("TEST 1: No need to shuffle deck cards\n");
  
  // check handCount
  printf("zzzadventurecardplay() | handCount | player %d | \n\t***check for expected value:", thisPlayer);
  ...
  // check deckCount
  printf("zzzadventurecardplay() | deckCount | player %d | \n\t***check for expected value:", thisPlayer);
  ...
  printf("zzzadventurecardplay() | cardCount | player %d | \n\t***check for expected value:", thisPlayer); 
