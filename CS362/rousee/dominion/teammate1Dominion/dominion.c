...
void zzzsalvagercardplay(int currentPlayer, int handPos, int choice1, struct gameState* state){
    //+1 buy
  state->numBuys++;
...
void zzzminioncardplay(int handPos, int choice1, int choice2, int i, int j, int currentPlayer, struct gameState* state){
     //+1 action
  state->numActions++;
