...
int main() {
	...
	// play smithy card in store_game
	zzzsmithycardplay(0, thisPlayer, handPos, store_game);
	// ----------- TEST 1: No need to shuffle deck cards --------------
	printf("TEST 1: No need to shuffle deck cards\n");
	
	// check handCount
	printf("zzzsmithycardplay() | handCount | player %d | \n\t***check for expected value:", thisPlayer);
	...
	// check deckCount
	printf("zzzsmithycardplay() | deckCount | player %d | \n\t***check for expected value:", thisPlayer);
	...
	// play the smithy card in store_game
	zzzsmithycardplay(0, thisPlayer, handPos, store_game);
	...
	// check playedCardCount
	printf("zzzsmithycardplay() | cardCount | player %d | \n\t***check for expected value:", thisPlayer); 
	if (store_game->playedCardCount != discarded)  {
		printf(" FAIL\n");
		printf("\tExpected %d playedCardCount, but was %d\n", discarded, store_game->playedCardCount);
	} 
