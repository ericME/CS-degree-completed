          ...
          if (httpRequest.status === 200) {
            ...
            switch (text[0]){
                ...
                default:
                    ...
                    alert("Login Error ... see log or contact CS419g6 :");
                    break;
            }
...
window.onload = function(){
    try {
        ...
        "<h1>Database Adminstration Login Page</h1>" +
        ...
        "<form method = 'POST'>" +
          ...
          "<p><input type=\"button\" value=\"Authorized User Login\" onclick=\"login()\" class=\"grnbtn\">" +
        "</form>";
    } catch (e) {
